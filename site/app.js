(()=>{var ru=document.querySelector("#hero > .reveal");ru&&(ru.className="reveal sac-hero",ru.innerHTML=`
  ...
  `);var au=[["hero","01","\u9996\u9875"],["projects","02","\u4F5C\u54C1"],["experience","03","\u6821\u56ED"],["practice","04","\u5B9E\u8DF5"],["content","05","\u5185\u5BB9"],["contact","06","\u8054\u7CFB"]],Jt=document.createElement("nav");Jt.className="planet-nav planet-nav--home";Jt.dataset.active="hero";Jt.setAttribute("aria-label","\u661F\u7403\u8F68\u9053\u5BFC\u822A");Jt.innerHTML=`
...
`].filter(Io).join(`
`)),a=Uf(a),a=Cm(a,t),a=Rm(a,t),o=Uf(o),o=Cm(o,t),o=Rm(o,t),a=Pm(a),o=Pm(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
